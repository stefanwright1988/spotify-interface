...
const Login = () => {
  ...
  return (
    <div className="login flex items-center align-middle content-center justify-center">
      <div
        id="card"
        className="flex flex-col bg-white rounded-md w-10/12 justify-center items-center align-middle self-center p-5"
      ...
      >
        ...
        <a
          id="user"
          href={AUTH_URL}
          className="loginButton flex bg-yellow-200 w-11/12 rounded-md text-center h-10 items-center"
