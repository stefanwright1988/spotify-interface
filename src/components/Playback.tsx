        ...
        <div className="flex flex-wrap h-full text-center px-4 py-2 w-1/3 lg:w-2/4 mr-2 text-gray-400">
          <div className="flex flex-wrap items-center justify-center text-center w-full h-auto">
            <svg
              ...
              viewBox="0 0 24 24"
            >
              <path d="M13.427 3.021h-7.427v-3.021l-6 5.39 6 5.61v-3h7.427c3.071 0 5.561 2.356 5.561 5.427 0 3.071-2.489 5.573-5.561 5.573h-7.427v5h7.427c5.84 0 10.573-4.734 10.573-10.573s-4.733-10.406-10.573-10.406z"></path>
            </svg>
            <svg
            ...
            <svg
              ...
              viewBox="0 0 24 24"
            >
              <path d="M10.573 3.021h7.427v-3.021l6 5.39-6 5.61v-3h-7.427c-3.071 0-5.561 2.356-5.561 5.427 0 3.071 2.489 5.573 5.561 5.573h7.427v5h-7.427c-5.84 0-10.573-4.734-10.573-10.573s4.733-10.406 10.573-10.406z"></path>
            </svg>
          </div>
