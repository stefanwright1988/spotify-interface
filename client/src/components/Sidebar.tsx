...
const Sidebar = () => {
  ...
  const inactiveLink = `flex items-center gap-5 pl-4 pt-4 pb-2.5 rounded-lg text-gray-700 dark:text-gray-200 text-md m-2 dark:hover:text-black hover:bg-light-gray`;
      ...
      {navActive && (
        <>
          <div className="flex justify-between items-center">
            ...
            <span onClick={() => dispatch(toggleNav())}>X</span>
          </div>
          <div className="mt-10">
